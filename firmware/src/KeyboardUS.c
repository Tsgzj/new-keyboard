...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_CAPS_LOCK, KEY_BACKSPACE, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTCONTROL, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFTSHIFT, KEY_E, KEY_BACKSPACE, KEY_ENTER, KEY_SPACEBAR, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_FN
};
