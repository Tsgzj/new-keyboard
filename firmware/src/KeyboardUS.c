...
static uint8_t const matrixRSTHD[8][12] = 
{
	...
	KEY_TAB, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_QUOTE,
	KEY_J, KEY_C, KEY_Y, KEY_F, KEY_K, 0, 0, KEY_Z, KEY_L, KEY_COMMA, KEY_U, KEY_Q,
	KEY_R, KEY_S, KEY_T, KEY_H, KEY_D, KEYPAD_NUM_LOCK, KEY_APPLICATION, KEY_M, KEY_N, KEY_A, KEY_I, KEY_O,
	KEY_SLASH, KEY_V, KEY_G, KEY_P, KEY_B, KEY_CAPS_LOCK, KEY_BACKSPACE, KEY_X, KEY_W, KEY_PERIOD, KEY_SEMICOLON, KEY_MINUS,
	KEY_ESCAPE, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFTCONTROL, KEY_E, KEY_BACKSPACE, KEY_ENTER, KEY_SPACEBAR, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_FN
};
