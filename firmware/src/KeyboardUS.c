...
static unit8_t const matrixRSTHD[8][12] = 
	{
	    ...
	    KEY_CAPS_LOCK, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_EQUAL,
	    KEY_J, KEY_C, KEY_Y, KEY_F, KEY_K, 0, 0, KEY_Z, KEY_L, KEY_PERIOD, KEY_U, KEY_Q,
	    KEY_R, KEY_S, KEY_T, KEY_H, KEY_D, KEY_NUMLOCK, KEY_APPLICATION, KEY_M, KEY_N, KEY_A, KEY_I, KEY_O,
