...
static uint8_t const baseKeys[BASE_MAX + 1][5] =
{
    ...
    {KEY_U, KEY_S, KEY_MINUS, KEY_R, KEY_ENTER},
...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_TAB, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_QUOTE,
    ...
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_CAPS_LOCK, KEY_ENTER, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTSHIFT, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFTCONTROL, KEY_SPACEBAR, KEY_BACKSPACE, KEY_ENTER, KEY_SPACEBAR, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_FN
};
...
static uint8_t const matrixDvorak[8][12] =
{
    ...
    KEY_TAB, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_MINUS,
    ...
    KEY_SEMICOLON, KEY_Q, KEY_J, KEY_K, KEY_X, KEY_CAPS_LOCK, KEY_ENTER, KEY_B, KEY_M, KEY_W, KEY_V, KEY_Z,
    KEY_LEFTSHIFT, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFTCONTROL, KEY_SPACEBAR, KEY_BACKSPACE, KEY_ENTER, KEY_SPACEBAR, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_FN
};

static uint8_t const matrixRSTHL[8][12] =
{
	KEY_LEFT_BRACKET, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10, KEY_F11, KEY_SLASH,
	KEY_GRAVE_ACCENT, KEY_F1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_F12, KEY_BACKSLASH,
	KEY_RIGHT_BRACKET, KEY_1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_0, KEY_EQUAL,
	KEY_TAB, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_QUOTE,
	KEY_Z, KEY_W, KEY_D, KEY_M, KEY_Q, 0, 0, KEY_J, KEY_F, KEY_B, KEY_U, KEY_BACKSLASH,
	KEY_R, KEY_S, KEY_T, KEY_H, KEY_L, KEYPAD_NUM_LOCK, KEY_APPLICATION, KEY_P, KEY_N, KEY_A, KEY_I, KEY_O,
	KEY_QUOTE, KEY_C, KEY_G, KEY_K, KEY_GRAVE_ACCENT, KEY_CAPS_LOCK, KEY_BACKSPACE, KEY_COMMA, KEY_V, KEY_X, KEY_Y, KEY_PERIOD,
	KEY_LEFTCONTROL, KEY_LEFTALT, KEY_LEFT_GUI, KEY_FN2, KEY_E, KEY_BACKSPACE, KEY_RIGHTSHIFT, KEY_SPACEBAR, KEY_FN, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_RIGHTCONTROL
};
