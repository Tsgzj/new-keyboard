...
static uint8_t const matrixDvorak[8][12] =
{
    ...
    KEY_LEFTSHIFT, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFTCONTROL, KEY_SPACEBAR, KEY_BACKSPACE, KEY_ENTER, KEY_SPACEBAR, KEY_RIGHTSHIFT, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_RIGHT_FN
};
...
static uint8_t const matrixRSTHL[8][12] =
{
	...
	KEY_TAB, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_ENTER,
	...
	KEY_LEFTCONTROL, KEY_LEFTALT, KEY_LEFT_GUI, KEY_LEFT_FN, KEY_E, KEY_BACKSPACE, KEY_RIGHTSHIFT, KEY_SPACEBAR, KEY_RIGHT_FN, KEY_RIGHT_GUI, KEY_RIGHTALT, KEY_RIGHTCONTROL
};
